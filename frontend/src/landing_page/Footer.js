...
function Footer() {
  return (
    <footer style={{ backgroundColor: "rgb(250,250,250)" }}>
        ...
        <div className="row mt-5">
          <div className="col">
            ...
            <div className="col">
              <div className="row">
                <i
                  class="fa-brands fa-linkedin-in text-small text-muted "
                  style={{ width: "3rem", fontSize: "30px" }}
                ></i>
                <i
                  class="fa-brands fa-facebook text-small text-muted "
                  style={{ width: "3rem", fontSize: "30px" }}
                ></i>
                <i
                  class="fa-brands fa-instagram text-small text-muted "
                  style={{ width: "3rem", fontSize: "30px" }}
                ></i>
              </div>
              <div className="row mt-5">
                <i
                  class="fa-brands fa-whatsapp text-small text-muted "
                  style={{ width: "3rem", fontSize: "30px" }}
                ></i>
                <i
                  class="fa-brands fa-youtube text-small text-muted "
                  style={{ width: "3rem", fontSize: "30px" }}
                ></i>
                <i
                  class="fa-brands fa-telegram text-small text-muted "
                  style={{ width: "3rem", fontSize: "30px" }}
                ></i>
              </div>
            </div>
      ...
      <div className="row p-2 text-small text-muted">
